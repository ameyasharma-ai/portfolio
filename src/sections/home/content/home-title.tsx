  ...
  return (
    <div className="w-full pointer-events-auto">
      <div className="max-w-3xl">
          ...
          <h1 className="font-heading text-left text-[clamp(2.2rem,7vw,5.5rem)] leading-[0.95] tracking-tight text-foreground">
            BUILDING FAST <br />
            SCALABLE WEB APPS
          </h1>

          <p className="mt-6 text-left text-sm md:text-lg text-muted-foreground max-w-xl">
